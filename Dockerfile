...
RUN git clone "https://github.com/KarypisLab/gklib" && sed 's/NAMELINK_ONLY//g' CMakeLists.txt && cd gklib && make config cc=gcc prefix=/usr shared=1 && make install && cd .. && rm -rf gklib && \
